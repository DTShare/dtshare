...
weather_df = dt.weather_daily(trade_date="20190801", city="北京")
print(weather_df)
```
...
```python
import dtshare as dt
weather_df = dt.weather_monthly(trade_date="20190801", city="北京")
print(weather_df)
```
...
```python
import dtshare as dt
air_hebei_df = dt.air_hebei(city="定州市")
print(air_hebei_df)
```
...
```python
import dtshare as dt
air_df = dt.air_hourly(city="上海", date="2019-12-05")
print(air_df)
```
...
```python
import dtshare as dt
air_df = dt.air_daily(city="上海", start_date="2019-11-01", end_date="2019-12-01")
print(air_df)
```
...
```python
import dtshare as dt
air_df = dt.air_all_city(period_type="HOUR", time_point="2019-12-01 20:00:00")
print(air_df)
```
...
```python
import dtshare as dt
air_df = dt.air_all_city(period_type="DAY", time_point="2019-12-01")
print(air_df)
```
...
```python
import dtshare as dt
fortune_df = dt.fortune_rank(year="2019")
print(fortune_df)
```
...
```python
import dtshare as dt
fortune_df = dt.fortune_rank_eng(year="2015")
print(fortune_df)
```
...
```python
import dtshare as dt
box_office_spot_df = dt.box_office_spot()
...
```python
import dtshare as dt
franchise_china_df = dt.franchise_china()
...
```python
import dtshare as dt
charity_china_organization_df = dt.charity_china_organization()
...
```python
import dtshare as dt
charity_china_trust_df = dt.charity_china_trust()
...
```python
import dtshare as dt
charity_china_plan_df = dt.charity_china_plan()
...
```python
import dtshare as dt
charity_china_progress_df = dt.charity_china_progress()
...
```python
import dtshare as dt
charity_china_report_df = dt.charity_china_report()
...
```python
import dtshare as dt
charity_china_platform_df = dt.charity_china_platform()
...
```python
import dtshare as dt
stock_js_weibo_report_df = dt.stock_js_weibo_report(time_period="CNHOUR12")
