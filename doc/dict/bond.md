...
```python
import dtshare as dt
bond_china_yield_df = dt.bond_china_yield(start_date="2018-01-01", end_date="2019-01-01")
...
```python
import dtshare as dt
bond_repo_zh_tick_df = dt.bond_repo_zh_tick(code="sz131802", trade_date="20200207")
...
```python
import dtshare as dt
bond_zh_hs_spot_df = dt.bond_zh_hs_spot()
...
```python
import dtshare as dt
bond_zh_hs_daily_df = dt.bond_zh_hs_daily(symbol="sh010107")
...
```python
import dtshare as dt
bond_zh_hs_cov_spot_df = dt.bond_zh_hs_cov_spot()
...
```python
import dtshare as dt
bond_zh_hs_cov_daily_df = dt.bond_zh_hs_cov_daily(symbol="sh113542")
...
4. 在安装dtshare后输入, 如 **dt.get_country_bond(country="中国", index_name="中国1年期国债", start_date='2000/01/01', end_date='2019/10/17')**;
5. 稍后就可以获得所需数据.
...
```python
import dtshare as dt
bond_df = dt.get_country_bond(country="中国", index_name="中国1年期国债", start_date='2000/01/01', end_date='2019/10/17')
print(bond_df)
print(bond_df.name)
```
