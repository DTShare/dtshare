...
股票指数信息一览表(可以在 dt.hare 中通过如下代码获取本表)

```python
import dtshare as dt
index_stock_info_df = dt.index_stock_info()
...
```python
import dtshare as dt
index_stock_cons_df = dt.index_stock_cons(index="000300")
...
4. 在安装后输入, 如 **dt.get_country_index(country="美国", index_name="美元指数", start_date='2000/01/01', end_date='2019/10/17')**;
5. 稍后就可以获得所需数据.
...
```python
import dtshare as dt
index_df = dt.get_country_index(country="美国", index_name="美元指数", start_date='2000/01/01', end_date='2019/10/17')
print(index_df)
print(index_df.name)
```
...
```python
import dtshare as dt
df_index = dt.weibo_index(word="期货", time_type="3month")
print(df_index)
```
...
index_df = dt.baidu_search_index(word="螺纹钢", start_date='2010-12-27', end_date='2019-12-01', cookie=cookie)
print(index_df)
```
...
import dtshare as dt
cookie = "此处输入您在网页端登录百度指数后的 cookie 数据"
index_df = dt.baidu_info_index(word="螺纹钢", start_date='2017-07-03', end_date='2019-12-01', cookie=cookie)
print(index_df)
```
...
import dtshare as dt
cookie = "此处输入您在网页端登录百度指数后的 cookie 数据"
index_df = dt.baidu_media_index(word="螺纹钢", start_date='2010-12-27', end_date='2019-12-01', cookie=cookie)
print(index_df)
```
...
```python
import dtshare as dt
index_df = dt.google_index(word="python", start_date='2004-01-01', end_date='2019-12-01', plot=True)
print(index_df)
```
...
![](https://jfds-1252952517.cos.ap-chengdu.myqcloud.com/dt.hare/readme/index/clipboard_20191204050206.png)

接口示例-短时间

```python
import dtshare as dt
index_df = df = dt.google_index(word="AI", start_date="2019-12-10T10", end_date="2019-12-10T23", plot=True)
print(index_df)
```
...
![](https://jfds-1252952517.cos.ap-chengdu.myqcloud.com/dt.hare/readme/index/clipboard_20191211034449.png)
...
```python
import dtshare as dt
sw_index_df = dt.sw_index_cons(index_code="801010")
print(sw_index_df)
```
...
```python
import dtshare as dt
sw_index_df = dt.sw_index_daily(index_code="801010", start_date="2019-12-01", end_date="2019-12-07")
print(sw_index_df)
```
...
```python
import dtshare as dt
sw_index_df = dt.sw_index_daily_indicator(index_code="801010", start_date="2019-12-01", end_date="2019-12-07", data_type="Day")
print(sw_index_df)
```
...
```python
import dtshare as dt
sw_index_df = dt.sw_index_daily_indicator(index_code="801010", start_date="2019-12-01", end_date="2019-12-07", data_type="Week")
print(sw_index_df)
```
...
```python
import dtshare as dt
spot_df = dt.spot_goods(symbol="波罗的海干散货指数")
print(spot_df)
```
...
```python
import dtshare as dt
index_yw_df = dt.index_yw(symbol="月景气指数")
print(index_yw_df)
```
