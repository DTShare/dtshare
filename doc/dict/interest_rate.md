...
macro_bank_usa_interest_rate_se = dt.macro_bank_usa_interest_rate()
...
```python
import dtshare as dt
macro_bank_euro_interest_rate_se = dt.macro_bank_euro_interest_rate()
...
```python
import dtshare as dt
macro_bank_newzealand_interest_rate_se = dt.macro_bank_newzealand_interest_rate()
...
```python
import dtshare as dt
macro_bank_china_interest_rate_se = dt.macro_bank_china_interest_rate()
...
```python
import dtshare as dt
macro_bank_switzerland_interest_rate_se = dt.macro_bank_switzerland_interest_rate()
...
```python
import dtshare as dt
macro_bank_english_interest_rate_se = dt.macro_bank_english_interest_rate()
...
```python
import dtshare as dt
macro_bank_australia_interest_rate_se = dt.macro_bank_australia_interest_rate()
...
```python
import dtshare as dt
macro_bank_japan_interest_rate_se = dt.macro_bank_japan_interest_rate()
...
```python
import dtshare as dt
macro_bank_russia_interest_rate_se = dt.macro_bank_russia_interest_rate()
...
```python
import dtshare as dt
macro_bank_india_interest_rate_se = dt.macro_bank_india_interest_rate()
...
```python
import dtshare as dt
macro_bank_brazil_interest_rate_se = dt.macro_bank_brazil_interest_rate()
...
```python
import dtshare as dt
rate_interbank_df = dt.rate_interbank(market="新加坡银行同业拆借市场", symbol="Sibor星元", indicator="3月")
