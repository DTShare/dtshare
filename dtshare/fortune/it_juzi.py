...
from dtshare.fortune.cons import it_headers, it_url
...
def nicorn_company():
    ...
    """
    temp_df = pd.read_csv(
        "https://jfds-1252952517.cos.ap-chengdu.myqcloud.com/dtshare/data/data_juzi/nicorn_company.csv",
        index_col=0,
    )
    for i in range(1, 2):
...
def maxima_company():
    ...
    """
    temp_df = pd.read_csv(
        "https://jfds-1252952517.cos.ap-chengdu.myqcloud.com/dtshare/data/data_juzi/maxima.csv",
        index_col=0,
    )
