...
with open('./dtshare/futures/exchange_symbol_list.pk', 'wb') as f:
    pickle.dump(exchange_symbol_list, f)

with open('./dtshare/futures/exchange_symbol_value_list.pk', 'wb') as f:
    pickle.dump(exchange_symbol_value_list, f)

with open('./dtshare/futures/code_exchange_name_dict.pk', 'wb') as f:
